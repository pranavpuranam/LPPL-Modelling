...
# ============================================================
# SETTINGS — SHU-SHORT POSITIVE LPPLS, COARSE T2 STEP 4
# ============================================================

PRICE_CSV = "eurostoxx600_prices.csv"

OUTPUT_CSV = "eurostoxx600_lppls_t2step4_shu_short_positive_fits.csv"
...
# Classic LPPLS bounds retained from your previous runs
M_BOUNDS = (0.1, 0.9)
OMEGA_BOUNDS = (6.0, 13.0)

# Shu-style short-window range, but coarser to keep fits near ~25k
DT_MIN = 30
DT_MAX = 200
DT_STEP = 10

# Coarse endpoint spacing to reduce computation
T2_STEP = 4
...
def plot_price_and_confidence(prices, confidence):
    ...
    ax2.plot(
        ...
        linestyle="--",
        linewidth=2.0,
        label="LPPLS Shu-Short Positive Confidence",
    )
