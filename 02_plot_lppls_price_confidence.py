...
CONFIDENCE_CSV = "eurostoxx600_lppls_t2step5_fullscale_positive_confidence.csv"
OUTPUT_PNG = "eurostoxx600_lppls_t2step5_fullscale_positive_price_confidence.png"
